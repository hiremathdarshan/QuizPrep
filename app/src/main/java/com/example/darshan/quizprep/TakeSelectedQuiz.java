...
public class TakeSelectedQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_take_selected_quiz);
    ...
    public void onsubmit(View view)
    {
        ...
        Intent I = new Intent(this, ViewQuizScore.class);
        startActivity(I);
    ...
    public void ListDrwaer() {
        ...
        lv=(ListView) findViewById(R.id.listView);
        lv.setAdapter(new CustomAdapter(this,que1 ,op11,op22,op33,op44,ans1));
